...
call SetHl('Statement', s:mods['none'], s:colors['turquoise_l'], s:colors['none'])
call SetHl('PreProc', s:mods['bold'], s:colors['royal_l'], s:colors['none'])
call SetHl('Conditional', s:mods['none'], s:colors['salmon_l'], s:colors['none'])
call SetHl('Delimiter', s:mods['none'], s:colors['salmon_d'], s:colors['none'])
call SetHl('Identifier', s:mods['none'], s:colors['white'], s:colors['none'])
call SetHl('Operator', s:mods['none'], s:colors['white'], s:colors['none'])
call SetHl('Constant', s:mods['none'], s:colors['white'], s:colors['none'])
call SetHl('String', s:mods['italic'], s:colors['white'], s:colors['none'])
call SetHl('Comment', s:mods['italic'], s:colors['gray'], s:colors['none'])
call SetHl('Special', s:mods['none'], s:colors['gray_l'], s:colors['none'])

"================================================ SETUP - SYNTAX - VIM
call SetHl('vimFunction', s:mods['none'], s:colors['turquoise_d'], s:colors['none'])
call SetHl('vimFuncName', s:mods['none'], s:colors['turquoise_d'], s:colors['none'])
call SetHl('vimUserFunc', s:mods['none'], s:colors['turquoise_d'], s:colors['none'])
call SetHl('vimAutoEvent', s:mods['none'], s:colors['salmon_l'], s:colors['none'])
call SetHl('vimFtOption', s:mods['none'], s:colors['salmon_l'], s:colors['none'])
call SetHl('vimHiGroup', s:mods['none'], s:colors['salmon_l'], s:colors['none'])
call SetHl('vimHiGUIFgBg', s:mods['none'], s:colors['salmon_l'], s:colors['none'])
call SetHl('vimHiCtermFgBg', s:mods['none'], s:colors['salmon_l'], s:colors['none'])
call SetHl('vimLet', s:mods['none'], s:colors['purple_l'], s:colors['none'])
call SetHl('vimFgBgAttrib', s:mods['none'], s:colors['white'], s:colors['none'])

"================================================ SETUP - SYNTAX - MARKDOWN
call SetHl('markdownCodeDelimiter', s:mods['none'], s:colors['turquoise_l'], s:colors['none'])
call SetHl('markdownBlockquote', s:mods['none'], s:colors['turquoise_l'], s:colors['none'])
call SetHl('markdownUrl', s:mods['none'], s:colors['royal_l'], s:colors['none'])
call SetHl('markdownLinktDelimiter', s:mods['none'], s:colors['royal_d'], s:colors['none'])
call SetHl('markdownLinkTextDelimiter', s:mods['none'], s:colors['royal_d'], s:colors['none'])
call SetHl('markdownH1', s:mods['none'], s:colors['salmon_l'], s:colors['none'])
call SetHl('markdownH2', s:mods['none'], s:colors['salmon_l'], s:colors['none'])
call SetHl('markdownH3', s:mods['none'], s:colors['salmon_l'], s:colors['none'])
call SetHl('markdownH4', s:mods['none'], s:colors['salmon_l'], s:colors['none'])
call SetHl('markdownH5', s:mods['none'], s:colors['salmon_l'], s:colors['none'])
call SetHl('markdownH6', s:mods['none'], s:colors['salmon_l'], s:colors['none'])
call SetHl('markdownH1Delimiter', s:mods['none'], s:colors['salmon_d'], s:colors['none'])
call SetHl('markdownH2Delimiter', s:mods['none'], s:colors['salmon_d'], s:colors['none'])
call SetHl('markdownH3Delimiter', s:mods['none'], s:colors['salmon_d'], s:colors['none'])
call SetHl('markdownH4Delimiter', s:mods['none'], s:colors['salmon_d'], s:colors['none'])
call SetHl('markdownH5Delimiter', s:mods['none'], s:colors['salmon_d'], s:colors['none'])
call SetHl('markdownH6Delimiter', s:mods['none'], s:colors['salmon_d'], s:colors['none'])
call SetHl('markdownLinkText', s:mods['none'], s:colors['white'], s:colors['none'])
call SetHl('markdownError', s:mods['none'], s:colors['white'], s:colors['none'])

"================================================ SETUP - SYNTAX - MAKEFILE
call SetHl('makeCommands', s:mods['none'], s:colors['turquoise_l'], s:colors['none'])
call SetHl('makeTarget', s:mods['none'], s:colors['salmon_l'], s:colors['none'])
call SetHl('makeSpecTarget', s:mods['none'], s:colors['salmon_l'], s:colors['none'])

"================================================ SETUP - SYNTAX - SHELL
call SetHl('shCommandSub', s:mods['none'], s:colors['turquoise_l'], s:colors['none'])
call SetHl('shFunctionOne', s:mods['none'], s:colors['turquoise_l'], s:colors['none'])
call SetHl('shFunctionTwo', s:mods['none'], s:colors['turquoise_l'], s:colors['none'])
call SetHl('shCase', s:mods['none'], s:colors['turquoise_l'], s:colors['none'])
call SetHl('shFunction', s:mods['none'], s:colors['turquoise_d'], s:colors['none'])
call SetHl('shRepeat', s:mods['none'], s:colors['royal'], s:colors['none'])
call SetHl('shLoop', s:mods['none'], s:colors['salmon_l'], s:colors['none'])
call SetHl('shCaseBar', s:mods['none'], s:colors['salmon_d'], s:colors['none'])
call SetHl('shSnglCase', s:mods['none'], s:colors['salmon_d'], s:colors['none'])
call SetHl('bashSpecialVariables', s:mods['none'], s:colors['purple_l'], s:colors['none'])
call SetHl('shOption', s:mods['none'], s:colors['white'], s:colors['none'])
call SetHl('shTestOpr', s:mods['none'], s:colors['white'], s:colors['none'])
call SetHl('shQuote', s:mods['none'], s:colors['white'], s:colors['none'])
call SetHl('shNoQuote', s:mods['none'], s:colors['white'], s:colors['none'])
call SetHl('shDerefOffset', s:mods['none'], s:colors['white'], s:colors['none'])
call SetHl('shDblParen', s:mods['none'], s:colors['white'], s:colors['none'])
call SetHl('shArithmetic', s:mods['none'], s:colors['white'], s:colors['none'])

"================================================ SETUP - SYNTAX - ASM
call SetHl('asmIdentifier', s:mods['none'], s:colors['turquoise_l'], s:colors['none'])
call SetHl('asmLabel', s:mods['none'], s:colors['salmon_l'], s:colors['none'])
call SetHl('asmDirective', s:mods['none'], s:colors['salmon_l'], s:colors['none'])
call SetHl('asmDecimal', s:mods['none'], s:colors['white'], s:colors['none'])
call SetHl('asmHexadecimal', s:mods['none'], s:colors['white'], s:colors['none'])

"================================================ SETUP - SYNTAX - C / C++
call SetHl('cUserFonction', s:mods['none'], s:colors['turquoise_l'], s:colors['none'])
call SetHl('cType', s:mods['none'], s:colors['royal'], s:colors['none'])
call SetHl('cRepeat', s:mods['none'], s:colors['salmon_l'], s:colors['none'])
call SetHl('cInclude', s:mods['none'], s:colors['purple_l'], s:colors['none'])
